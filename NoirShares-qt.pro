...
# also add new translations to src/qt/NoirShares.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/NoirShares_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/NoirShares-qt.rc src/test/*.cpp src/test/*.h src/qt/test/*.cpp src/qt/test/*.h
...
windows:RC_FILE = src/qt/res/NoirShares-qt.rc
...
macx:ICON = src/qt/res/icons/NoirShares.icns
